...
local CameraShakePresets = {
	...
	SustainedRoar = function()
		local c = CameraShakeInstance.new(3.75, 7.5, 0, 1.5)
		c.PositionInfluence = Vector3.new(0.25, 0.25, 0.25)
		c.RotationInfluence = Vector3.new(4, 1, 1)
		return c
	end;
	...
	Bump2 = function()
		local c = CameraShakeInstance.new(2.5, 4, 0.1, 0.75)
		c.PositionInfluence = Vector3.new(4, 4, 2)
		c.RotationInfluence = Vector3.new(2, 2, 1)
		return c
	end;

	SmallBump = function()
		local c = CameraShakeInstance.new(1.25, 2, 0.1, 0.75)
		c.PositionInfluence = Vector3.new(0.15, 0.15, 0.15)
		c.RotationInfluence = Vector3.new(1, 1, 1)
		return c
	end;
